...
import { TransformPropertyPanel } from '@/features/map-editor/components/panels/TransformPropertyPanel';
...
export class TransformComponent extends Component {
  ...
  renderPropertyPanel(props: ComponentPanelProps): ReactNode {
    return <TransformPropertyPanel component={this} onChange={props.onChange} />;
  }
}
