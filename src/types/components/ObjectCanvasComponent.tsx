...
import { ObjectCanvasPropertyPanel } from '@/features/map-editor/components/panels/ObjectCanvasPropertyPanel';
...
export class ObjectCanvasComponent extends Component {
  ...
  renderPropertyPanel(props: ComponentPanelProps): ReactNode {
    return <ObjectCanvasPropertyPanel component={this} onChange={props.onChange} />;
  }
}
