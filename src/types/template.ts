 ...
 *
 * TODO: GameEngine テンプレート対応
 *   src/engine/ 以下のゲームエンジン（GameEngine / EventRunner / actions 等）も
...
export interface TemplatePackage {
  ...
  // TODO: engine?: GameEngineConfig
  //   ゲームエンジン（src/engine/ 以下）のテンプレート対応。
  //   Lite ではエンジン全体（GameEngine / EventRunner / actions）がテンプレートのみ使用可能、
  //   Full では自由に改造可能とする。
